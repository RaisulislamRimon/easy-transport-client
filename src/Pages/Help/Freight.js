...
const Freight = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `url("https://static.autox.com/uploads/2020/10/2020-skoda-rapid-1-litre-tsi-automatic-review-rear-static-m.jpg")`,
      }}
    >
      ...
      <div className="hero-content text-center  text-neutral-content">
        <div className="max-w-md">
          <h1 className="mb-5 text-3xl font-bold">
            Welcome to Easy Transport Support
          </h1>
