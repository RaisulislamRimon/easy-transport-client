...
const Help = () => {
    return (
        <div className="hero min-h-screen" style={{ backgroundImage: `url("https://images.pexels.com/photos/53594/blue-clouds-day-fluffy-53594.jpeg?cs=srgb&dl=pexels-pixabay-53594.jpg&fm=jpg")` }}>
            <div className="hero-overlay bg-opacity-50"></div>
            <div className='grid lg:grid-cols-6 grid-cols-2 gap-6'>
                <div className='w-[150px] h-[150px] bg-white rounded'>
                    <Link to='/help/riders'>
                        <button>
                            <p className=' text-3xl ml-9 mt-6  '><BiCar /> </p>
                ...
                <div className='w-[150px] h-[150px] bg-white rounded'>
                    <Link to='/help/driving'>
                        <button>
                            <p className=' text-3xl ml-9 mt-6  '><BiBuoy /> </p>
                ...
                <div className='w-[150px] h-[150px] bg-white rounded'>
                    <Link to='/help/marchants'>
                        <button>
                            <p className=' text-3xl ml-9 mt-6  '><BiRestaurant /> </p>
                ...
                <div className='w-[150px] h-[150px] bg-white rounded'>
                    <Link to='/help/bikes'>
                        <button>
                            <p className=' text-3xl ml-9 mt-6  '><MdOutlineBikeScooter /> </p>
                ...
                <div className='w-[150px] h-[150px] bg-white rounded'>
                    <Link to='/help/business'>
                        <button>
                            <p className=' text-3xl ml-9 mt-6  '><MdBusinessCenter /> </p>
                ...
                <div className='w-[150px] h-[150px] bg-white rounded'>
                    <Link to='/help/freight'>
                        <button>
                            <p className=' text-3xl ml-9 mt-6  '><BiBusSchool /> </p>
