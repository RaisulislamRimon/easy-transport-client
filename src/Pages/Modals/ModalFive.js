    ...
    <div>
      ...
      <div className="modal">
        <div className="modal-box relative">
          <label htmlFor="booking-modal5" className="btn btn-sm btn-circle absolute right-2 top-2">✕</label>

          <form action="" onSubmit={handelmodal} className='grid grid-cols-1 gap-5 mt-10'>
            <input name='name' type="text" placeholder={service?.product5[0]?.name} className="input w-full font-bold text-black-500 input-bordered" />
            ...
            <button htmlFor="booking-modal5" className='btn w-full btn-accent font-bold'>Submit</button>
