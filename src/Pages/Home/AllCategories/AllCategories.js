...
const AllCategories = () => {
  ...
  return (
    <div>
      ...
      <div className="grid gap-3 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:p-10">
        <div className="card  bg-gradient-to-r from-blue-500 via-red-500 to-yellow-500  shadow-xl">
          <figure>
            <img
        ...
        <div className="card bg-gradient-to-r from-blue-500 via-red-500 to-yellow-500 mb-8 mt-8 shadow-xl">
          <figure>
            <img
        ...
        <div className="card  bg-gradient-to-r from-blue-500 via-red-500 to-yellow-500 mt-8 mb-8 shadow-xl">
          <figure>
            <img
